...
n_heads, mlm_prob, n_layers, hidden_size, d_ff = (
    best_hyperparams['n_heads'],
    best_hyperparams['mlm_prob'],
    best_hyperparams['n_layers'],
    best_hyperparams['hidden_size'],
    best_hyperparams['d_ff'],
)
...
model_config = RobertaConfig(
    ...
    intermediate_size=antiberta_config.get("d_ff", 3072),
    type_vocab_size=1,
)
